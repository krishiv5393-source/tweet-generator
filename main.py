...
st.set_page_config(page_title='Tweet Generator', page_icon='https://icons8.com/icon/8824/twitter-bird', layout="wide", initial_sidebar_state="auto", menu_items=None)
